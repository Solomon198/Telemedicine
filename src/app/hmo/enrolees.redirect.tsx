        ...
        return (
            <Container style={styles.mainContainer}>
                ...
                <Header hasTabs  androidStatusBarColor={Colors.Brand.brandColor} style={styles.header}>
                    ...
                    <Body>
                       <Title style={{color:Colors.Brand.brandColor,fontWeight:"bold"}}>Select an enrolee</Title>
                    </Body>
...

              {
                  ...
                  <FlatList
                   ...
                   renderItem={({item,index})=>
                      ...
                      <ListItem 
                          style={styles.items}  
                          onPress={()=>this.navigate(this.props.isMedicalBills?"stack.hmo.medicalBills":"stack.hmo.medicalReports",item)} 
                          key={index} 
                          noIndent 
                          noBorder 
                      >
